declare @CostPerVCoreSecond numeric(7,6);
set @CostPerVCoreSecond = 0.000145;
SELECT TOP(50) 
	qs.execution_count AS [Execution Count],
	(qs.total_worker_time) * @CostPerVCoreSecond as TotalCost,
	(qs.total_worker_time / qs.execution_count) * @CostPerVCoreSecond as AverageCost,
...
-- order by [Total Worker Time (ms)] desc
