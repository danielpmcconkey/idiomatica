...
namespace Logic.Telemetry
{
    public static class ErrorHandler
    {
        ...
        private static Dictionary<int, string> _errorCodes = new Dictionary<int, string>()
        {
            ...
            { 1210, "LoggedInUser cannot be null and LoggedInUser.Id cannot be null or 0 when clearing page" },
            { 1220, "LoggedInUser cannot be null and LoggedInUser.Id cannot be null or 0 when archiving a book" },
            { 1221, "LoggedInUser cannot be null and LoggedInUser.Id cannot be null or 0 when adding a book" },
            ...
            { 2420, "token.Word cannot be null and token.Word.Id must be greater than 0 in word modal" },
            { 2430, "wordUser cannot be null and wordUser.Id must be greater than 0 in word modal" },
            { 2440, "BookTag ID returned null or 0 while saving or saving failed" },
            { 2450, "LoggedInUser cannot be null when reading book list" },
            { 2460, "WordUser.WordId is null or 0 when trying to create new flash cards." },
