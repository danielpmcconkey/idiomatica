...
namespace Logic
{
    ...
    public static class StatisticsHelper
    {
        ...
        //public static string? GetBookUserStat_string(List<BookUserStat> bookUserStats, AvailableBookUserStat key)
        //{
        //    if (bookUserStats == null) return null;
        //    var existingStat = bookUserStats.Where(x => x.Key == key).FirstOrDefault();
        //    if (existingStat == null) return null;
        //    return existingStat.ValueString;
        //}
        ...
        //    var floatVal = existingStat.ValueNumeric;
        //    if (floatVal == null) return null;
            
        //    return (int)(Math.Floor((decimal)floatVal));
        //}
        ...
        //    var existingStat = GetBookUserStat_string(bookUserStats, key);
        //    bool parsedStat = false;
        //    if (bool.TryParse(existingStat, out parsedStat)) return null;
        //    return parsedStat;
        //}
