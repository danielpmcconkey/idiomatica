...
namespace TestDataPopulator.Migrations
{
    ...
    [Migration("20240929112333_AddWordUserProgressTotalTable")]
    partial class AddWordUserProgressTotalTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Model.WordUserProgressTotal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("WordUserProgressTotal", "Idioma");
                });
            ...
            modelBuilder.Entity("Model.WordUserProgressTotal", b =>
                {
                    b.HasOne("Model.LanguageUser", "LanguageUser")
                        .WithMany("WordUserProgressTotals")
                        .HasForeignKey("LanguageUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Model.LanguageUser", b =>
                {
                    ...
                    b.Navigation("WordUserProgressTotals");
